  ...
  return (
    <section>
      <div className="flex-wrap space-x-4 justify-center items-center lg:flex hidden py-[32px]">
        {buttons.map((text, index) => (
          <button
            ...
            className={`text-blue-600 lg:text-body-p0 text-res-body-p0 !font-semibold xl:px-[48px] md:px-[38px] px-[28px] py-[6px] xl:py-[8px] rounded-[200px] transition-colors duration-300 text-blue-main ${
      ...
      <div id="home-technology__carousel__container" className="relative">
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <article className="grid lg:grid-cols-2 grid-cols-1 md:gap-[32px] lg:p-[64px] rounded-[20px] mb-5 p-[24px] lg:h-[550px] bg-white">
                <section className="lg:space-y-md space-y-sm">
                  <header className="lg:space-y-md space-y-10">
                    <h6 className="undefined lg:text-head-6 text-xl text-res-head-6 uppercase text-blue-500 font-Montserrat">
                      Secure and safe
                    </h6>
                    <h3 className="undefined text-3xl text-res-head-3 lg:text-head-3 font-Montserrat">
                  ...
                  <div className="text-blue-950">
                    <div className="text-body-1">
                      <p className="mt-7">
                        ...
                        security standards, drawing on 20 years of technical
                        expertise.
                      </p>
                    </div>
                    <div className="text-body-1">
                      <p className="mt-3">
                        ...
                        million customers, and benefit from our secure, robust
            ...
            <div className="swiper-slide">
              <article className="grid lg:grid-cols-2 grid-cols-1 md:gap-[32px] lg:p-[64px] rounded-[20px] mb-5 p-[24px] lg:h-[550px] bg-white">
                <section className="lg:space-y-md space-y-sm">
                  <header className="lg:space-y-md space-y-10">
                    <h6 className="undefined lg:text-head-6 text-res-head-6 uppercase text-xl text-blue-500 font-Montserrat">
                      Compliance ready
                    </h6>
                    <h3 className="undefined text-blue-text text-3xl text-res-head-3 lg:text-head-3 font-Montserrat">
                  ...
                  <div className="text-blue-950">
                    <div className="text-body-1">
                      <p className="mt-4">
                        <strong>
                          Navigate through the evolving regulatory landscape
                          with confidence by streamlining compliance
                          management—through real-time risk monitoring solutions
                    ...
                    <div className="text-body-1">
                      <p>
                        ...
                        technology that is designed for seamless integration
                        with core banking and card payment systems.
                      </p>
                    </div>
                  </div>
                </section>
              ...
              <article className="grid lg:grid-cols-2 grid-cols-1 md:gap-[32px] lg:p-[64px] rounded-[20px] mb-5 p-[24px] lg:h-[550px] bg-white">
                <section className="lg:space-y-md space-y-sm">
                  <header className="lg:space-y-md space-y-10">
                    ...
                    <h3 className="undefined text-3xl text-blue-text text-res-head-3 lg:text-head-3 font-Montserrat">
                  ...
                  <div className="text-blue-950">
                    <div className="text-body-1">
                      <p className="mt-7">
                        <strong>
                          Innovate with evolving customer demands through our
                          open platform-based technology architecture. Stay
                          ahead of the ever-changing financial landscape with a
                          strong focus on security, compliance and performance.
                        </strong>
                      </p>
                    </div>
                    <div className="text-body-1">
                      <p>
                        ...
                        and deliver an extraordinary customer experience, with
            ...
            <div className="swiper-slide">
              <article className="grid lg:grid-cols-2 grid-cols-1 md:gap-[32px] lg:p-[64px] rounded-[20px] mb-5 p-[24px] lg:h-[550px] bg-white">
                <section className="lg:space-y-md space-y-sm">
                  <header className="lg:space-y-md space-y-10">
                    <h6 className="undefined lg:text-head-6 text-res-head-6 text-xl uppercase text-blue-500 font-Montserrat">
                      Customer focused
                    </h6>
                    <h3 className="undefined text-blue-text text-3xl text-res-head-3 lg:text-head-3 font-Montserrat">
        ...
        <div
          style={{ "--bullet-bg": "#d9ebff" }}
          className="swiper-pagination undefined svelte-17j2dom"
        ></div>
      </div>
    </section>
  );
