    ...
    <>
      ...
      <div className="border border-black mt-20">
        <section
          ...
          className="max-w-[1200px] mx-auto lg:h-[max(620px,_calc(92vh-49px))] h-auto relative w-full lg:bg-clip-hero-container overflow-hidden pt-[30%] md:pt-[20%] lg:pt-0 max-lg:pb-[15%] svelte-n9olsd"
        >
          <div className="container relative z-10 w-full h-full md:flex md:items-center md:justify-center">
            <div className="h-fit lg:flex-[65] xl:flex-[75]">
              <header className="max-w-2xl lg:space-y-sm space-y-[16px] mb-[32px]">
                <h1 className="lg:max-w-max lg:whitespace-pre-line lg:text-head-1 font-Montserrat text-res-head-1">
                  Embrace the future of finance
                </h1>
                <h5 className="!max-w-[37rem] lg:mr-5 text-res-head-5 text-blue-main lg:text-head-5 font-Montserrat">
              ...
              <div className="flex lg:flex-row flex-col lg:space-x-[16px] space-y-4 lg:space-y-0 w-full lg:mb-0 mb-md max-w-xl">
                <a
                  className="md:py-[15.5px] py-[14px] px-[42px] rounded-xs shadow-button-primary text-link flex items-center justify-center space-x-[8px] bg-orange-main false"
                  href="https://anytxn.com/en/contact-us"
                >
          ...
          <div className="hidden lg:block absolute top-0 xl:left-[35%] xl:w-[65%] left-1/2 lg:w-[56%] h-full bg-clip-hero-image pointer-events-none svelte-1lc7tvy">
            <figure
              ...
              style={{
                transform: "translate3d(-12%, 0.7984%, 0px)",
                transition:
          ...
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-gradient-dark to-transparent bg-clip-content"></div>
        </section>
      </div>
            ...
            <div className="!my-[60px] md:hidden block relative h-fit lg:text-clip">
              ...
              >
                <img
                  ...
                  loading="lazy"
                  src="./Home Page _ AnyTech_files/background.svg"
      ...
      <div className="border border-black mt-20">
        <section className="max-w-[1200px] mx-auto">
          <div className="container flex w-full items-start justify-center h-full relative z-10 flex-col mt-6">
            <h2 className="font-Montserrat text-res-head-2 lg:text-head-2 font-semibold mb-[24px]">
              Legacy no longer
            </h2>
