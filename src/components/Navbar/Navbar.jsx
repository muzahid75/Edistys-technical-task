...
const Navbar = () => {
  ...
  return (
    <header className="text-blue-950 max-lg:bg-blue-main max-lg:py-8 top-0 lg:absolute w-full lg:pt-[17px] lg:pb-[25px] text-res-body-p1 lg:text-body-p1 z-[9999]  ">
              ...
              >
                ...
                <img
                  ...
                  style={{
                    ...
                    height: "auto",
                    objectFit: "cover",
                    filter: "invert(1)", // Apply a filter to invert colors and make the logo black
                  }}
                />
              </picture>
            </a>
                ...
                <div className="ml-6 my-auto">
                  <div className="relative lg:block hidden">
                    <button
                      ...
                      className="rounded-[132px] flex items-center justify-center space-x-[8px] border px-[14px] py-[8px] lg:text-body-p1 text-res-body-p0 border-white"
                    >
                      <svg
                        width="12"
                        height="13"
